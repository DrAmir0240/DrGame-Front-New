...
const statusConfig: Record<string, { label: string; color: string }> = {
  ...
  primary: { label: "اولیه", color: "bg-blue-100 text-blue-700 border-blue-200" },
  finalize: { label: "نهایی", color: "bg-emerald-100 text-emerald-700 border-emerald-200" },
  in: { label: "دریافتی", color: "bg-emerald-100 text-emerald-700 border-emerald-200" },
  out: { label: "پرداختی", color: "bg-red-100 text-red-700 border-red-200" },
};
